...
##*请同学们仔细阅读本仓库页面上**"公告"**一栏的5、6、7条的内容，有问题的在本仓库的**"Issues"**上的"Git和Github使用方法提问专用贴"上提问~*
...
7. **时间**：2015/04/07  **内容**：github issue使用方法<br> **说明**：请参考[如何向开源社区提问题][16]<br>
8. **时间**：2015/04/07  **内容**：重要通知!!!<br> **说明**：为保持仓库的稳定，以后的公告消息发布会转移到github issues，望周知~<br>
