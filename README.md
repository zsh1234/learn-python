...
###公告
- **时间**：2015/03/20  **内容**第一个练习<br> **说明**：课堂PPT的P62页:练习(2)-加权平均分计算<br> **参考**：hello.py
...
- **时间**：2015/04/07  **内容**：作业模板<br> **说明**：以后做作业把test0-0.py文件复制一份改名后再写你们自己的代码<br>
- **时间**：2015/04/07  **内容**：github简单教程<br> **说明**：同学们仔细看看我写的教程http://pan.baidu.com/s/1qWyWfrm，基本上可以对付作业提交问题了<br>
- **时间**：2015/04/07  **内容**：利用github issue提问<br> **说明**：打开本仓库的页面，点击右侧的"Issues"，就像百度贴吧一样发帖提问(
- **时间**：2015/04/07  **内容**：github issue使用方法<br> **说明**：请参考[如何向开源社区提问题][16]<br>
- **时间**：2015/04/07  **内容**：重要通知!!!<br> **说明**：为保持仓库的稳定，以后的公告消息发布会转移到github issues，望周知~<br>
